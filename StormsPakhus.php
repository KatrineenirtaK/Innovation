...
<div id="page-headline">Storms Pakhus</div>

<!-- Koden nedenfor er generet via KultuNaut -->
<div id="widget941"></div>
<script>
  (function(d){
    var id='nautwidget941';if (d.getElementById(id)) {return;}
    var js=d.createElement('script');js.id=id;
    js.async=true;js.type='text/javascript';
    js.src="https://www.kultunaut.dk/perl/widget/type-nynaut/load.js?Id=941";
