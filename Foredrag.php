...
<div id="page-headline">Foredrag og fortællinger</div>

<h3>Odense Congress Center</h3>

<!-- Koden nedenfor er generet via KultuNaut -->
<div id="widget942"></div>
<script>
  (function(d){
    var id='nautwidget942';if (d.getElementById(id)) {return;}
    var js=d.createElement('script');js.id=id;
    js.async=true;js.type='text/javascript';
    js.src="https://www.kultunaut.dk/perl/widget/type-nynaut/load.js?Id=942";
...
<h3>Hovedbiblioteket</h3>

<!-- Koden nedenfor er generet via KultuNaut -->
<div id="widget943"></div>
<script>
  (function(d){
    var id='nautwidget943';if (d.getElementById(id)) {return;}
    var js=d.createElement('script');js.id=id;
    js.async=true;js.type='text/javascript';
    js.src="https://www.kultunaut.dk/perl/widget/type-nynaut/load.js?Id=943";
    var node=d.getElementsByTagName('script')[0];
    node.parentNode.insertBefore(js, node);
  }(document));
</script>
