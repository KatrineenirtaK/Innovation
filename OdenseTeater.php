...
<div id="page-headline">Odense Teater</div>

<!-- Koden nedenfor er generet via KultuNaut -->
<div id="widget944">
<script>
  (function(d){
    var id='nautwidget944';if (d.getElementById(id)) {return;}
    var js=d.createElement('script');js.id=id;
    js.async=true;js.type='text/javascript';
    js.src="https://www.kultunaut.dk/perl/widget/type-nynaut/load.js?Id=944";
